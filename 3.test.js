...
const transporteRegalos = (tipoRegalos, nombreRenos) => {
...
describe('transporteRegalos', () => {
    ...
    it('el 1er parámatro debe ser un string', () => {
...
it('el 2º parámatro debe ser un string', ()=> {
...
it('el numero de cajas se pueden transportar', () => {
